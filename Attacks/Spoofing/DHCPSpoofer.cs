...
namespace eExNetworkLibrary.Attacks.Spoofing
{
    ...
    public class DHCPSpoofer : DHCPServer
    {
        ...
        protected override void HandleDHCPFrame(DHCPFrame dhcFrame, EthernetFrame ethFrame, UDP.UDPFrame udpFrame, IP.IPv4Frame ipv4Frame, TrafficDescriptionFrame tdf)
        {
