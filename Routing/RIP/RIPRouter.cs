    ...
    public class RIPRouter : RoutingProcess
    {
        ...
        protected override void HandleTraffic(Frame fInputFrame)
        {
            ...
            if (!bShutdownPending)
            {
                ...
                IP.IPv4Frame ipFrame = GetIPv4Frame(fInputFrame);
        ...
        private bool HandleRIPV1(UDP.UDPFrame udpFrame, IP.IPv4Frame ipFrame)
        {
            RIPFrame fRIPFrame;
            bool bChanged = false;
        ...
        /// <param name="ipFrame"></param>
        /// <returns>Bool indicating if something changed</returns>
        private bool HandleRIPV2(UDP.UDPFrame udpFrame, IP.IPv4Frame ipFrame)
        {
            RIPFrame fRIPFrame;
            bool bChanged = false;
