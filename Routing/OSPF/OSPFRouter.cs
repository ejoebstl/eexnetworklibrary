...
namespace eExNetworkLibrary.Routing.OSPF
{
    ...
    class OSPFRouter : DirectInterfaceIOHandler, IOSPFRouter
    {
        ...
        private IPv4AddressAnalysis ipv4Analysis;
        ...
        public OSPFRouter()
        {
            ...
            ipv4Analysis = new IPv4AddressAnalysis();
        ...
        void tHello_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            foreach (DirectAttachedNetwork dan in arDan)
            {
                if (dan.AssociatedArea != null)
                {
                    IP.IPv4Frame ipFrame = CreateIPFrame(dan.InterfaceAddress, this.ipaAllOSPFRouters);
        ...
        private IPv4Frame CreateIPFrame(IPAddress ipaSource, IPAddress ipaDestination)
        {
        ...
        private void HandleHello(OSPFCommonHeader ospfHeader, OSPFHelloMessage ospfHello, IPv4Frame ipv4Frame, EthernetFrame ethFrame)
        {
