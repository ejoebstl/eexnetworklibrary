...
namespace eExNetworkLibrary
{
    ...
    {
        // #############################
        // # Network Library Protocols #
        // #############################

        /// <summary>
        /// Returns a bool indicating whether a given frame has the type IPv4 or IPv6
        /// </summary>
        /// <param name="fFrame">The frame to check</param>
        /// <returns>A bool indicating whether a given frame has the type IPv4 or IPv6</returns>
